...
subplot(1,2,1);
  ...
  ylabel (Ax(2), ["Factor de Friccion $f$"],"fontsize", 8,"fontname",tpo);
  ...
  %title(["$Q$ y $f$ en función de $D$"],'fontsize', 10);
...
print -dpdflatexstandalone diamtroDe3.pdf
system ("pdflatex diamtroDe3");
