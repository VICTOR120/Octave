...
subplot(1,2,1);
  ...
  xlabel (Ax(1), "Diámetro de Tubería D [mm]","fontsize", 10, "fontname",tpo);
  ...
  set(H1, "linestyle","-","linewidth",1.2,'color','k','marker','o','MarkerSize',4, 'MarkerFaceColor','k');
  xp = D_cf(nr)*1000;
  yp = Q_cf(nr)*1000;
...
subplot(1,2,2);
  ...
  ylabel("Diámetro de Tubería D [mm]","fontsize", 10,"fontname",tpo);
  xlabel("Número de iteraciones","fontsize", 10,"fontname",tpo);
...
print -dpdflatexstandalone diamtroDe2.pdf
system ("pdflatex diamtroDe2");
